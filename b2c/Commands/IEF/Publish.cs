...
public class Publish : BaseCommand
{
    ...
    //[Option(ShortName = "s", LongName = "sequence", OptionType = CommandOptionType.MultipleValue,
    ...
    public async Task OnExecuteAsync()
    {
        ...
        if (string.IsNullOrEmpty(Folder) || FileSequence == null || string.IsNullOrEmpty(envName))
